...
export default function CalendarScreen() {
  ...
  const { addEvent, deleteEvent, getEventsForDate, getEventDates } =
    useCalendarJournal();
  ...
  console.log(
    "[CalendarScreen] Rendering for date:",
    selectedDate,
    "month:",
      ...
      >
        ...
        <View style={styles.dayLabelsRow}>
          {DAY_LABELS.map((label) => (
            <View
              key={label}
              style={[styles.dayLabelCell, { width: DAY_CELL_SIZE }]}
            >
