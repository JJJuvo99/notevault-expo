  ...
  const { messages, sendMessage, error } = useRorkAgent({
    tools: {
      generateNote: createRorkTool({
        description:
          "Generate a note based on a topic or idea provided by the user",
        zodSchema: z.object({
        ...
        execute(toolInput): string {
          console.log(
            "[AIChat] Tool executed: generateNote with title:",
            toolInput.title,
          );
        ...
        {displayMessages.length === 0 ? (
          <View style={styles.welcomeContainer}>
            ...
            <Text style={styles.welcomeSubtitle}>
              Ask me anything — brainstorm ideas, draft notes, summarize
              content, or get writing help.
            </Text>
