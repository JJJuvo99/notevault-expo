...
export default function NotebooksHomeScreen() {
  ...
  const handleNotebookLongPress = useCallback(
    (notebookId: string, notebookName: string) => {
      if (notebookName === "Calendar" || notebookName === "Journal") return;

      void Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium);

      Alert.alert(notebookName, "What would you like to do?", [
            ...
            Alert.alert(
              ...
              [
...

                {
                  ...
                  onPress: () => {
                    console.log(
                      "[NotebooksHome] Deleting notebook:",
                      notebookName,
                    );
    ...
    >
      ...
      >
        ...
        <Animated.View style={[styles.pinnedRow, { opacity: fadeAnim }]}>
          {notebooks
            .filter((nb) => nb.name === "Journal" || nb.name === "Calendar")
            .map((notebook) => (
              <NotebookCard
                key={notebook.id}
                notebook={notebook}
