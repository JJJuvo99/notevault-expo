...
export default function SearchScreen() {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]} testID="search-screen">
      ...
      <View style={styles.searchBar}>
        ...
        />
        {query.length > 0 && (
          <Pressable onPress={handleClearSearch} hitSlop={8} testID="btn-clear-search">
      ...
      {query.length === 0 ? (
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptySubtitle}>Find anything across all your notebooks</Text>
        </View>
      ) : results.length === 0 ? (
        <View style={styles.emptyState}>
